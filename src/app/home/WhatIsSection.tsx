  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16">
      <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
        <div>
          <p className="text-sm font-semibold text-teal mb-2">What&rsquo;s Ash&rsquo;s Resorts?</p>
          <h2 className="font-display text-3xl sm:text-4xl text-ink mb-2">
            Timeshare Rentals
            <br />
            <span className="text-teal">Made Easy</span>
          </h2>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button className="rounded-lg bg-teal px-5 py-2.5 text-sm font-medium text-sand-light hover:bg-teal-dark transition">
              Learn More
            </button>
            <button className="rounded-lg border border-line px-5 py-2.5 text-sm font-medium text-ink/80 hover:bg-sand transition">
              Rent your timeshare
            </button>
          </div>
        </div>
